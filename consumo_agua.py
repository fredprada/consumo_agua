...
# 🔹 1️⃣ Seleção ou criação de usuário
usuarios = obter_usuarios()
usuario_selecionado = st.selectbox("Selecione um usuário:", ["(Novo Usuário)"] + usuarios)

if usuario_selecionado == "(Novo Usuário)":
    usuario_id = st.text_input("Digite o nome do novo usuário:")
else:
