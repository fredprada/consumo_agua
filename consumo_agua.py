...
if usuario_id and filtrar:
    ...
    if not historico.empty:
        ...
        col3.metric(label="Falta para Meta", value=f"{restante_meta}ml")

    else:
        st.write("Nenhum registro encontrado.")

# 🔹 5️⃣ Ranking de Consumo Médio Diário
if filtrar:
...
if usuario_id and filtrar:
    ...
    if not historico_usuario.empty:
        ...
        # Garantir todas as horas no eixo X do gráfico
        ...
        fig_media_hora = px.bar(
            ...
            category_orders={"hora": list(range(24))}  # Mantém a ordem correta das horas
        )
