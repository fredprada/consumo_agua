...
if usuario_id and filtrar:
    ...
    if not historico.empty:
        # Ajustar fuso horário e criar coluna de data
...
# 🔹 5️⃣ Ranking dos Usuários - Consumo Médio Diário
if filtrar:
...
# 🔹 6️⃣ Histórico de Consumo (filtrado corretamente)
if usuario_id and filtrar:
