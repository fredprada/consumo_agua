...
# Exibe a imagem do Pedrito no topo
if pedrito_img:
    st.image(pedrito_img, width=150)

# Define o título do app e o ícone do navegador
st.set_page_config(page_title="Pedrito, o Fiscal da Hidratação", page_icon=pedrito_img)
