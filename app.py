...
if usuario_id and filtrar:
    ...
    if not historico.empty:
        ...
        ultimos_14_dias = hoje - timedelta(days=14)
        ...
        # 📊 Gráfico: Consumo por Dia (Últimos 14 dias)
        consumo_usuario = historico_usuario[historico_usuario["data"] >= ultimos_14_dias].copy()
        consumo_usuario["cor"] = consumo_usuario["data"].apply(lambda x: "gray" if x == hoje else "blue")
        ...
        max_percentual = max(consumo_usuario["percentual_meta"].max(), 120) + 0.1
        ...
        fig_meta.update_yaxes(range=[0, max_percentual])
