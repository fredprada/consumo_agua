...
if usuario_id and filtrar:
    ...
    if not historico.empty:
        ...
        consumo_usuario["cor"] = consumo_usuario["data"].apply(lambda x: "gray" if x == hoje else "#636EFA")
        ...
        # Correção da linha vertical no dia atual
        fig_meta.add_vline(
            x=pd.Timestamp(hoje),  # Conversão correta para evitar erro
