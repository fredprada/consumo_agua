...
if usuario_id and filtrar:
    ...
    if not historico_usuario.empty:
        ...
        fig_meta = px.line(consumo_por_dia, x="data", y="percentual_meta", markers=True, title="Evolução do Consumo Diário (%) da Meta")
        fig_meta.update_layout(yaxis_title="Percentual da Meta (%)", xaxis_title="Data")
